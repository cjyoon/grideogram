...
# grch37 = read_delim('~/Documents/cjyoon/scripts/grideogram/grideogram/inst/extdata/grch37_cytoBandIdeo.txt', delim='\t', col_names=c('chromosome', 'start', 'end', 'band', 'stain'))
# grch38 = read_delim('~/Documents/cjyoon/scripts/grideogram/grideogram/inst/extdata/grch38_cytoBandIdeo.txt', delim='\t', col_names=c('chromosome', 'start', 'end', 'band', 'stain'))
...
# grch38_chrom_size =  setNames(grch38_chrom_size_df$size, grch39_chrom_size_df$chrom)
